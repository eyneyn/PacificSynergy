...
@section('content')
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3 rtl:space-x-reverse">
        ...
        <li>
          <div class="flex items-center">
              ...
              <a href="{{ url('registration') }}" class="ms-1 text-sm font-medium text-blue-800 hover:text-blue-600 md:ms-2">Register new user</a>
          </div>
        </li>
    </ol>
    </nav>
    ...
    <form method="POST" action="{{ route('registration_post') }}" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-3 gap-4">
    @csrf
        <!-- Header Section -->
        <div class="md:col-span-3 text-center mb-4 mt-3">
            <div class="flex items-center justify-center space-x-4">
                ...
                <!-- Title and Subtext -->
                <div class="text-left">
                    <h2 class="text-lg font-semibold text-blue-950">User Profile</h2>
        ...
        <!-- Row 1: Last name - First Name - Photo Upload-->
            ...
            <div class="mb-1 col-span-1">
                ...
                <input type="text" name="last_name" class="bg-transparent border border-[#0F1C39] text-blue-950 text-sm rounded-lg focus:ring-[#0F1C39] focus:border-[#0F1C39] block w-full p-2.5" placeholder="Dela Cruz" required autofocus/>
                @error('last_name')
            ...
            <div class="mb-1 col-span-1">
                ...
                <input type="text" name="first_name" class="bg-transparent border border-[#0F1C39] text-blue-950 text-sm rounded-lg focus:ring-[#0F1C39] focus:border-[#0F1C39] block w-full p-2.5" placeholder="Juanita" required/>
                @error('first_name')
                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
