    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3 rtl:space-x-reverse">
        ...
        <li>
          <div class="flex items-center">
              ...
              <a href="{{url('admin/index')}}" class="ms-1 text-sm font-medium text-blue-800 hover:text-blue-600 md:ms-2">Production Reports</a>
          </div>
        </li>
        <li>
          <div class="flex items-center">
              ...
              <a href="{{ url('registration') }}" class="ms-1 text-sm font-medium text-blue-800 hover:text-blue-600 md:ms-2">Daily Production Report</a>
          </div>
        </li>
    </ol>
    </nav>

    <div class="max-w-6xl mt-8 mx-auto bg-white backdrop-blur-md border border-gray-500 rounded-md py-5 px-5">
